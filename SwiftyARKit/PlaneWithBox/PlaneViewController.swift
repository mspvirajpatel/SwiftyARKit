...
class PlaneViewController: UIViewController, ARSCNViewDelegate, SCNPhysicsContactDelegate, UIGestureRecognizerDelegate {
    
    @IBOutlet var sceneView: ARSCNView!
    
    var planes = [ARPlaneAnchor: PlaneView]()
    var boxes = [SCNNode]()
    ...
    func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
        ...
        DispatchQueue.main.async {
            if let planeAnchor = anchor as? ARPlaneAnchor {
                ...
                let plane = PlaneView(planeAnchor, isHidden: false)
